...
public class Particles2 extends ApplicationAdapter {
    ...
    protected void onLoaded () {
        ...
        addEmitter(new float[] {0.8f, 0.4f, 0.5f}, particleTexture, tmpVector.set(-5, 5, 0), Vector3.X, -360);
        addEmitter(new float[] {0.4f, 0.8f, 0.1f}, particleTexture, tmpVector.set(0, -5, 5), Vector3.Y, -360);
        addEmitter(new float[] {0.8f, 0.2f, 1f}, particleTexture, tmpVector.set(0, 5, -5), Vector3.Z, -360);
